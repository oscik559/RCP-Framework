...
RAG_BASELINE_DIR = PROJECT_ROOT / "Experiments" / "Case_I" / "Baseline_RAG"
sys.path.insert(0, str(RAG_BASELINE_DIR))

# Import the baseline and the judge logic (reusing LLMJudge from evaluate_rag)
from Experiments.Case_I.Baseline_Agentic_No_RCP.agentic_no_rcp_baseline import AgenticNoRCPBaseline
from Experiments.Case_I.Baseline_RAG.evaluate_rag import LLMJudge, parse_test_questions
...
def main():
    ...
    parser.add_argument("--questions-file", type=str, default=str(PROJECT_ROOT / "Experiments" / "questions" / "test_questions_categorized.txt"))
