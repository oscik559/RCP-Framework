...
python -m Experiments/Case_II.run_evaluation_saab --baseline all

# Run individual baselines
python -m Experiments/Case_II.run_evaluation_saab --baseline b1   # Naive RAG
python -m Experiments/Case_II.run_evaluation_saab --baseline b2   # SQL Retrieval
python -m Experiments/Case_II.run_evaluation_saab --baseline b3   # Full RCP

# Limit to first N questions (for quick testing)
python -m Experiments/Case_II.run_evaluation_saab --baseline b3 --limit 5
```
