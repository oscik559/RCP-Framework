...
def main():
    ...
    parser.add_argument("--pdf-path", default="Layer_1_Extraction/Layer_1a/High-Pressure_Hose.pdf", help="Path to PDF file (default: Layer_1_Extraction/Layer_1a/High-Pressure_Hose.pdf)")
