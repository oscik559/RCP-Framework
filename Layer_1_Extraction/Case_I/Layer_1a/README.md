...
```bash
python Layer_1_Extraction/Case_I/Layer_1a/1_pdf_to_png.py Layer_1_Extraction/Case_I/Layer_1a/High-Pressure_Hose.pdf
```

**Output**: `Layer_1_Extraction/Case_I/Layer_1a/data/png_pages/` - PNG images of each page

### 2. `2_detect_headers_footers.py`
Identifies and marks header/footer regions on pages.

```bash
python Layer_1_Extraction/Case_I/Layer_1a/2_detect_headers_footers.py
```
...
```bash
python Layer_1_Extraction/Case_I/Layer_1a/3_detect_tables.py
```

**Output**: `Layer_1_Extraction/Case_I/Layer_1a/data/tables/` - JSON files with table data

### 4. `4_extract_product.py`
Extracts product specifications using Vision Language Models (Ollama + Qwen).

```bash
python Layer_1_Extraction/Case_I/Layer_1a/4_extract_product.py Layer_1_Extraction/Case_I/Layer_1a/High-Pressure_Hose.pdf --page 31
```
...
```bash
python Layer_1_Extraction/Case_I/Layer_1a/5_extract_images.py
```

**Output**: `Layer_1_Extraction/Case_I/Layer_1a/data/output/` - Extracted images
...
All Layer 1a outputs are stored in `Layer_1_Extraction/Case_I/Layer_1a/data/`:

- `Layer_1_Extraction/Case_I/Layer_1a/data/png_pages/` - PNG conversions of PDF pages
- `Layer_1_Extraction/Case_I/Layer_1a/data/tables/` - Extracted table data (JSON format)
- `Layer_1_Extraction/Case_I/Layer_1a/data/output/` - Visualization images with bounding boxes
- `Layer_1_Extraction/Case_I/Layer_1a/data/exports/` - CSV/Excel exports (if applicable)
...
→ **Use Layer 1b instead**: See `Layer_1_Extraction/Case_I/Layer_1b/README.md`
