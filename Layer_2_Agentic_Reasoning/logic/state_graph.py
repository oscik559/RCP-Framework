...
# Graph files stored in Layer_2_Agentic_Reasoning/outputs/ folder
...
def _generate_png_diagram() -> None:
    ...
    try:
        ...
        if result.returncode == 0:
            debug.print_system("PNG diagram auto-generated: check Layer_2_Agentic_Reasoning/outputs/graph.png", "✅")
        else:
