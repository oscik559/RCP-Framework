...
**Current Production**: See `Layer_1b_Extraction` for the actively maintained pipeline
...
**Output**: `Layer_1a_Extraction/data/png_pages/` - PNG images of each page

### 2. `2_detect_headers_footers.py`
Identifies and marks header/footer regions on pages.

```bash
python Layer_1a_Extraction/2_detect_headers_footers.py
```
...
**Output**: `Layer_1a_Extraction/data/tables/` - JSON files with table data
...
```bash
python Layer_1a_Extraction/5_extract_images.py
```

**Output**: `Layer_1a_Extraction/data/output/` - Extracted images
...
All Layer 1a outputs are stored in `Layer_1a_Extraction/data/`:

- `Layer_1a_Extraction/data/png_pages/` - PNG conversions of PDF pages
- `Layer_1a_Extraction/data/tables/` - Extracted table data (JSON format)
- `Layer_1a_Extraction/data/output/` - Visualization images with bounding boxes
- `Layer_1a_Extraction/data/exports/` - CSV/Excel exports (if applicable)
...
→ **Use Layer 1b instead**: See `Layer_1b_Extraction/README.md`
