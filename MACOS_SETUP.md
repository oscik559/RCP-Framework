...
Expected output:
```
✅ agentic.db initialized successfully
✅ Library tables populated in agentic database
```
...
```python
CONFIG = {
    "agentic_db": "data/database/agentic.db",      # Workflow tracking
    "harvested_db": "data/database/harvested.db",  # Product data
    "output_db": "data/database/output.db",        # Query results
}
```
