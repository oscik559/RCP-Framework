...
python -m Layer_Experiments.run_evaluation --baseline all

# Run individual baselines
python -m Layer_Experiments.run_evaluation --baseline b1   # Naive RAG
python -m Layer_Experiments.run_evaluation --baseline b2   # SQL Retrieval
python -m Layer_Experiments.run_evaluation --baseline b3   # Full RCP (with forced strategies)

# Limit to first N questions (for quick testing)
python -m Layer_Experiments.run_evaluation --baseline b3 --limit 5
```
