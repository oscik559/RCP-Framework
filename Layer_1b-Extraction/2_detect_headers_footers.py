...
class RegionManager:
    def __init__(self):
        ...
        self.output_dir = self.script_dir / "data/regions"
    ...
    def mark_regions_on_image(self, pdf_name, page_number, results):
        """
        ...
        # Save marked image
        output_filename = f"{pdf_name}_page_{page_number:03d}_regions.png"
    ...
    def process_page(self, pdf_path, page_number):
        ...
        # Get PDF name for marking
        pdf_name = Path(pdf_path).stem
        
        # Mark regions on image
        self.mark_regions_on_image(pdf_name, page_number, results)
