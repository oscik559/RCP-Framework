...
The following 50 queries were curated from the Hydroscand product database to evaluate the RAG baseline, the Agentic (No RCP) pipeline, and the proposed RCP framework. The final three columns report primary error classes according to the taxonomy defined in Section~\ref{subsec:error_analysis}.
