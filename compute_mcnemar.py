"""
Compute McNemar's test statistics and Wilson CIs for paper update.
Run after Hydroscand B3 100q and Saab B1 100q results are available.

Usage: python3 compute_mcnemar.py
"""
import json
import math
...
# ── Case I ──────────────────────────────────────────────────────────────────
b1_i = load("Layer_Experiments/results_appendix_b/b1_rag_latest.json")
b2_i = load("Layer_Experiments/results_appendix_b/b2_sql_latest.json")
b3_i = load("Layer_Experiments/results_appendix_b/b3_rcp_latest.json")
...
# ── Case II ─────────────────────────────────────────────────────────────────
b1_ii = load("Layer_Experiments_Saab/results/b1_rag_latest.json")
b2_ii = load("Layer_Experiments_Saab/results/b2_sql_latest.json")
b3_ii = load("Layer_Experiments_Saab/results/b3_rcp_latest.json")
